...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "98 publications (last updated July 2026) in reversed chronological order.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
            ...
            window.open("https://medium.com/@plegg/hacking-the-hdmi-airwaves-side-channel-attacks-to-recover-a-target-display-part-1-7a62aab1789e?source=rss-b5e2ee2ae6ee------2", "_blank");
        ...
        handler: () => {
          ...
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/resources_more/";
